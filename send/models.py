...
class TeacherUser(models.Model):
    user=models.OneToOneField(User)
    send_or_get = models.BooleanField() #true send
...
class OrderForm(models.Model):
    ...
    send_people = models.ManyToManyField(TeacherUser)
    ...
    order_case = models.CharField(max_length=5)     # 1-order without get 2-order on the way 2 order has sent
